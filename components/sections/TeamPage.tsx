      ...
      <section className="relative pt-36 pb-20 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          <FadeUp delay={0.15}>
            ...
            >
              Seasoned Kingdom professionals committed to raising Holy
              Spirit-led innovators who use their gifts to impact lives and
              reveal Jesus Christ to the world.
            </p>
          </FadeUp>
        </div>
      </section>
              ...
              <StaggerChild key={i}>
                ...
                >
                  ...
                  >
                    {member.photo ? (
                      ...
                      <div
                        ...
                        style={{
                          background:
                            "linear-gradient(135deg, #1a2565, #080d2e)",
                        }}
                      >
                    ...
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(to top, #111850 0%, transparent 55%)",
                      }}
                    />
                    {/* Label badge */}
                    <div className="absolute top-5 left-5">
                      <span className="text-[11px] font-bold px-4 py-1.5 rounded-full grad-bg text-[#080d2e] tracking-widest uppercase">
                        {member.label}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="p-8">
                    ...
                    <p className="text-[#00c9ff] text-sm font-semibold mb-5">
                      {member.role}
                    </p>
                    {member.bio && (
              ...
              <StaggerChild key={i}>
                ...
                >
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, rgba(0,201,255,0.15), rgba(0,255,157,0.15))",
                    }}
                  >
                    <span className="text-2xl">💻</span>
                  </div>
                  <div>
                    <span className="text-[10px] font-bold tracking-[0.15em] uppercase grad-text block mb-1">
                      {member.label}
                    </span>
                    <h4
        ...
        <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
          <FadeUp>
            ...
            <p className="text-[#8892b0] text-lg mb-10 max-w-lg mx-auto leading-relaxed">
              We&apos;re always looking for mentors, collaborators, and
              Kingdom-minded professionals to join this movement.
            </p>
            <a href="/join">
              <motion.button
                whileHover={{
