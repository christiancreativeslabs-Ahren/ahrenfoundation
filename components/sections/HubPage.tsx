...
export default function HubPage() {
  return (
    <main className="bg-[#080d2e] overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          <FadeUp>
            ...
            <h1
              ...
              style={{ fontFamily: "var(--font-display)", fontSize: "clamp(32px, 5vw, 60px)", fontWeight: 800, letterSpacing: "-0.03em" }}
            >
              Welcome to <span className="grad-text">Ahren Hub</span>
              <br className="hidden sm:block" /> Your Gateway to our Global Community of Christian Creatives
            </h1>
          </FadeUp>
          <FadeUp delay={0.15}>
            <p className="text-[#8892b0] leading-relaxed max-w-3xl" style={{ fontSize: "clamp(16px, 2vw, 19px)" }}>
              Ahren Hub is your gateway to our Youth Empowerment &amp; Mentorship Programs — whether
              you&apos;re joining the 6-Week Tech &amp; Creativity Mentorship or continuing as a
              verified member. Connect, learn, and grow with like-minded believers using tech and
              creativity to build, serve and impact this generation for Jesus Christ.
            </p>
          </FadeUp>
        </div>
      </section>
      ...
      {/* ── JOIN THE PROGRAM ── */}
      <section className="pb-8 pt-4 relative" style={{ borderTop: "1px solid rgba(0,201,255,0.08)" }}>
        <div className="max-w-4xl mx-auto px-6 pt-14">
            ...
            >
              ...
              <div className="relative z-10">
                <div className="inline-flex items-center gap-2 rounded-full px-3 py-1.5 mb-4" style={{ background: "rgba(0,201,255,0.1)", border: "1px solid rgba(0,201,255,0.2)" }}>
                  ...
                  <span className="text-[#00c9ff] text-[11px] font-bold tracking-widest uppercase">Join the Program</span>
                </div>
                ...
                <p className="text-[#8892b0] text-base leading-relaxed">
                  Are you a curious, creative, tech-inclined believer ready to learn how to steward
                  your skills, gifts and creative prowess for God&apos;s purposes on earth? Then this
                  program is for you — we invite you to apply.
                </p>
              </div>
            </div>
          </FadeUp>
          ...
          <FadeUp delay={0.08}>
            <motion.div
              ...
              style={{ background: "linear-gradient(135deg, rgba(0,255,157,0.09) 0%, rgba(0,201,255,0.06) 100%)", border: "1px solid rgba(0,255,157,0.28)" }}
            >
              <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                ...
                <p className="text-[#e8eeff] text-sm md:text-[15px] leading-relaxed">
                  The program kicks off virtually in <span className="text-white font-bold">September 2026</span>,
                  {" "}running over 6 Saturdays. Application deadline:{" "}
                  <span className="text-white font-bold">August 22, 2026</span>. Spots are limited!
                </p>
              </div>
            </motion.div>
          </FadeUp>
          ...
          {/* Not sure */}
          <FadeUp delay={0.18}>
            <div className="rounded-2xl p-6 mb-4 text-center" style={{ background: "rgba(0,255,157,0.05)", border: "1px solid rgba(0,255,157,0.15)" }}>
              ...
              <p className="text-[#8892b0] text-sm leading-relaxed max-w-xl mx-auto">
                Apply anyway. We will help you discover how your creativity, gifts &amp; skills are
                valuable to God&apos;s purpose on earth.
              </p>
            </div>
          </FadeUp>
        </div>
        ...
        <div className="max-w-3xl mx-auto px-6 relative z-10">
          <FadeUp className="text-center mb-10">
            ...
            <h2
              ...
              style={{ fontFamily: "var(--font-display)", fontSize: "clamp(26px, 3.5vw, 44px)", fontWeight: 800, letterSpacing: "-0.02em" }}
            >
          ...
          <FadeUp delay={0.1}>
            <div className="card p-8 md:p-10" style={{ borderRadius: 28 }}>
              {/* Lock notice */}
              <div className="flex items-start gap-4 mb-8 p-5 rounded-2xl" style={{ background: "rgba(0,201,255,0.05)", border: "1px solid rgba(0,201,255,0.12)" }}>
                <div className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0 text-[#00c9ff]" style={{ background: "rgba(0,201,255,0.12)" }}>
                  <Lock size={20} />
                </div>
                <p className="text-[#8892b0] text-sm leading-relaxed">
                  Access to our Community Hub is exclusively for verified members. If you have not yet
                  registered for our training program, you will not be able to log in.
                </p>
              </div>

              {/* Steps to become verified */}
              <div className="mb-8">
                <h3 className="text-white font-bold text-base mb-5" style={{ fontFamily: "var(--font-display)" }}>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-4 p-4 rounded-xl" style={{ background: "#111850", border: "1px solid rgba(0,201,255,0.08)" }}>
                      <span className="w-8 h-8 rounded-full grad-bg flex items-center justify-center flex-shrink-0 text-[#080d2e] font-bold text-sm">
                        {i + 1}
                      </span>
                      <span className="text-[#e8eeff] text-sm leading-snug">{step}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <p className="text-[#8892b0] text-sm leading-relaxed mb-6">
                If you have already been accepted into our training program, please log in below to
                access your weekly modules, assignments and community resources.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <motion.a
                  href={LOGIN_URL}
                  whileHover={{ scale: 1.03, boxShadow: "0 0 36px rgba(0,201,255,0.35)" }}
                  whileTap={{ scale: 0.97 }}
