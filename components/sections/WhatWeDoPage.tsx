  ...
  return (
    <main className="bg-[#080d2e] overflow-hidden">
      ...
      <section className="relative pt-36 pb-20 overflow-hidden">
        ...
        <GradientOrb className="top-[-10%] left-[-5%]" size={600} color="cyan" />
        <GradientOrb className="bottom-[-20%] right-[-5%]" size={500} color="mint" />
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          <FadeUp delay={0.15}>
            <p className="text-[#8892b0] leading-relaxed max-w-2xl" style={{ fontSize: "clamp(16px, 2vw, 20px)" }}>
              Rooted in faith, driven by purpose, and powered by the Holy Spirit — every initiative we run is designed to align tech skills, creativity, and community with God&apos;s eternal purpose.
            </p>
          </FadeUp>
        </div>
      </section>
                  ...
                  <div className="grid lg:grid-cols-[auto_1fr_auto] gap-8 items-start">
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        />
                        <span className="text-[#8892b0] text-xs">Initiative {String(i + 1).padStart(2, "0")}</span>
                      </div>
                      <h3
                      ...
                      <p className="text-[#8892b0] text-[15px] leading-relaxed max-w-2xl">{item.desc}</p>
                    </div>
      ...
      >
        <GradientOrb className="left-[-10%] top-[-20%]" size={600} color="mint" />
        <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
          <FadeUp>
            ...
            <p className="text-[#8892b0] text-lg max-w-2xl mx-auto leading-relaxed mb-12">
              More than a program — it&apos;s a thriving, Spirit-filled community. Our Believers in Tech Fellowship
              is where faith-driven technologists find genuine connection, sharpen each other, and build Kingdom
              products together in an atmosphere of fun, faith, and purpose.
            </p>
              ...
              {[
                ...
                <StaggerChild key={i}>
                  ...
                  >
                    ...
                    <span className="text-white text-sm font-semibold" style={{ fontFamily: "var(--font-display)" }}>
                      {item.label}
                    </span>
                  </motion.div>
                </StaggerChild>
      ...
      <section className="py-24 relative">
        ...
        <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
          <FadeUp>
            ...
            >
              Ready to be Part of <span className="grad-text">Something Great?</span>
            </h2>
            <p className="text-[#8892b0] text-lg mb-10 leading-relaxed">
              Join a growing community of believers who are using their tech gifts to build for the Kingdom.
            </p>
