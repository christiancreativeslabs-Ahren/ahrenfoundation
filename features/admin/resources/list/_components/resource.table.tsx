...
import {
  ResourceFilterSheet,
  type ResourceListFilterState,
} from "./resource.filter.sheet";
            ...
            <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
              <div className="space-y-2">
                ...
                <CardDescription className="max-w-2xl text-sm leading-relaxed text-slate-300">
                  Fast cursor listing for dashboard resources, built on the
                  shared table system.
                </CardDescription>
              </div>
            ...
            {[
              {
                ...
                value:
                  summary?.total ?? data?.totalCount ?? initialData.totalCount,
              },
        ...
        <Card className="border-white/10 bg-white/[0.03] text-white">
          <CardHeader className="pb-4">
            ...
            <CardDescription className="text-slate-300">
              Showing the current resource queue with cursor pagination and
              URL-backed filters.
            </CardDescription>
          </CardHeader>
            ...
            <DataTableToolbar
              ...
              title={
                <h2 className="text-2xl font-bold">
                  Resources [
                  {formatCount(data?.totalCount ?? initialData.totalCount)}]
                </h2>
              }
