...
import { MentorMenteeAssignmentDialog } from "./mentor-mentee-assignment-dialog";

export function MentorListActions({
  mentor,
  mentees,
  onViewDetails,
  className,
