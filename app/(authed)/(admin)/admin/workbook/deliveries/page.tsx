...
import {
  formatAdminDate,
  getWorkbookDeliveryOverviewData,
...
export default async function AdminWorkbookDeliveriesPage() {
  ...
  const statCards = [
    { label: "Total applicants", value: overview.applications.total },
    ...
    { label: "Applicants reviewing", value: overview.applications.reviewing },
    { label: "Applicants pending", value: overview.applications.pending },
    { label: "Applicants rejected", value: overview.applications.rejected },
    { label: "Scheduled deliveries", value: overview.deliveries.scheduled },
    { label: "Sent deliveries", value: overview.deliveries.sent },
    { label: "Skipped deliveries", value: overview.deliveries.skipped },
    { label: "Failed deliveries", value: overview.deliveries.failed },
    { label: "Completed deliveries", value: overview.deliveries.completed },
    { label: "Cancelled deliveries", value: overview.deliveries.cancelled },
    { label: "Total submissions", value: overview.submissions.total },
      ...
      <Card className="border-white/10 bg-white/[0.03] text-white">
        <CardHeader>
          ...
          <CardDescription className="max-w-3xl text-slate-300">
            Manage the dynamic Ahren Workbook engine: enrollments, deliveries,
            email send health, Workbook engagement, and submission flow.
          </CardDescription>
        </CardHeader>
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        <Card className="border-white/10 bg-white/[0.03] text-white">
          <CardHeader>
            ...
            <CardDescription className="text-slate-300">
              Latest opens, clicks, Workbook views, and submissions.
            </CardDescription>
          </CardHeader>
        ...
        <Card className="border-white/10 bg-white/[0.03] text-white">
          <CardHeader>
            ...
            <CardDescription className="text-slate-300">
              Latest assignment submissions across Workbook modules.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
        ...
        <Card className="border-white/10 bg-white/[0.03] text-white">
          ...
          <CardContent className="grid gap-3">
            {[
              ...
              { href: "/admin/workbook/submissions", label: "Open submission review" },
