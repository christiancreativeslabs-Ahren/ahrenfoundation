      ...
      <Card className="border-white/10 bg-white/[0.03] text-white">
          ...
          <div className="mt-3 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
              ...
              <CardDescription className="mt-2 text-slate-300">
                Mentee profile, mentor assignment, Workbook journey, and
                submission history.
              </CardDescription>
            </div>
              ...
              <MemberLoginLinkDialog
                member={{
                  ...
                  loginCredentialsSentAt:
                    journey.member.loginCredentialsSentAt?.toISOString() ??
                    null,
                }}
              />
            </div>
        ...
        <CardContent className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
          {[
            ...
            [
              "Active mentor",
              activeAssignment?.mentorMemberId ? "Assigned" : "Unassigned",
            ],
          ].map(([label, value]) => (
            <div
              key={label}
      ...
      <Card className="border-white/10 bg-white/[0.03] text-white">
        <CardHeader>
          ...
          <CardDescription className="text-slate-300">
            Deliveries, engagement, and latest assignment answers for this
            mentee.
          </CardDescription>
        </CardHeader>
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell className="space-y-2 whitespace-normal text-sm text-slate-300">
                      ...
                      <p>
                        Started:{" "}
                        {formatAdminDate(item.delivery.assignmentStartedAt)}
                      </p>
                      <p>
                        Submitted:{" "}
                        {formatAdminDate(item.delivery.assignmentSubmittedAt)}
                      </p>
                    </TableCell>
                    <TableCell className="whitespace-normal">
                      {latestSubmission ? (
                        <div className="space-y-3">
                          <p className="text-xs font-semibold text-[#00ff9d]">
                            Submitted{" "}
                            {formatAdminDate(latestSubmission.submittedAt)}
                          </p>
