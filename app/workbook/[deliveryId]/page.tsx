...
import { submitWorkbookAssignment } from "@/actions/workbook-delivery";
import { db } from "@/db";
...
export default async function WorkbookTokenAccessPage({
  params,
  searchParams,
}: {
  ...
  const progressLabel =
    hasSubmitted && module.moduleNumber === 12 ? "Final Module" : "Workbook Module";
        ...
        <article className="space-y-8">
          <section className="rounded-[32px] border border-white/10 bg-white/[0.05] p-7 shadow-[0_24px_80px_rgba(0,0,0,0.24)] backdrop-blur-sm md:p-8">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="rounded-full bg-white/5 px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.18em] text-slate-300">
                {module.moduleNumber === 12 ? "Commissioning" : "Workbook"}
              </span>
            </div>
          ...
          {submitted ? (
            <Alert type="success">
              ...
              anytime to review the Workbook module and continue your journey.
            </Alert>
          ) : null}
          ...
          <SectionCard eyebrow="Opening" title="Start with the Workbook module">
          ...
          >
            ...
            <form action={submitWorkbookAssignment} className="space-y-6">
        ...
        <aside className="space-y-4 lg:sticky lg:top-6 lg:self-start">
          ...
          <section className="rounded-[28px] border border-white/10 bg-white/[0.05] p-5 shadow-[0_18px_60px_rgba(0,0,0,0.2)] backdrop-blur-sm">
            ...
            <dl className="mt-4 space-y-3 text-sm">
              ...
              <div className="flex justify-between gap-4">
                <dt className="text-slate-400">Workbook started</dt>
                <dd className="font-semibold text-white">
          ...
          <section className="rounded-[28px] border border-white/10 bg-white/[0.05] p-5 shadow-[0_18px_60px_rgba(0,0,0,0.2)] backdrop-blur-sm">
            ...
            <div className="mt-4 space-y-3 text-sm leading-6 text-slate-300">
              <p>
                This Workbook page includes the full module content, the
